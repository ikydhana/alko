<?php namespace App\Http\Controllers;
	...
	class AdminTbPetugas22Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->where = "id_cms_privileges, 2";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nama Petugas","name"=>"name"];
			$this->col[] = ["label"=>"Email Petugas","name"=>"email"];
			$this->col[] = ["label"=>"Jumlah Point","name"=>"point"];
