<?php namespace App\Http\Controllers;
	...
	class AdminTbDisposisiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Nama Pelapor','name'=>'id_lapor','type'=>'datamodal','width'=>'col-sm-10','datamodal_table'=>'tb_lapor','datamodal_columns'=>'nama_pelapor,satuan_kerja','datamodal_where'=>'status = "Belum Selesai"'];
			...
			$this->form[] = ['label'=>'Petugas Pelaksana','name'=>'id_petugas','type'=>'datamodal','width'=>'col-sm-10','datamodal_table'=>'cms_users','datamodal_columns'=>'name','datamodal_where'=>'id_cms_privileges = 2'];
