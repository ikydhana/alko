...
<head>
    ...
    <?php if($load_css): ?>
        <?php $__currentLoopData = $load_css; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $css): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<!-- load js -->
<?php if($load_js): ?>
    <?php $__currentLoopData = $load_js; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $js): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
