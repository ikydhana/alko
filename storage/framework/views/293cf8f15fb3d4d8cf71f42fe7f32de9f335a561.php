            ...
            <ul class="nav navbar-nav"> 
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul id='list_notifications' class="dropdown-menu">
                        <li class="header"><?php echo e(trans("crudbooster.text_no_notification")); ?></li>
                        <li>
                            ...
                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 200px;">
                                <ul class="menu" style="overflow: hidden; width: 100%; height: 200px;">
                                    <li>
                                        <a href="#">
                                            <em><?php echo e(trans("crudbooster.text_no_notification")); ?></em>
                                        </a>
                                    </li>
                        ...
                        <li class="footer"><a href="<?php echo e(route('NotificationsControllerGetIndex')); ?>"><?php echo e(trans("crudbooster.text_view_all_notification")); ?></a></li>
                    </ul>
                </li>
                        ...
                        <li class="user-footer">
                            <div class="pull-<?php echo e(trans('crudbooster.left')); ?>">
                                <a href="<?php echo e(route('AdminCmsUsersControllerGetProfile')); ?>" class="btn btn-default btn-flat"><i
                                            class='fa fa-user'></i> <?php echo e(trans("crudbooster.label_button_profile")); ?></a>
                            </div>
                            <div class="pull-<?php echo e(trans('crudbooster.right')); ?>">
                                <a title='Lock Screen' href="<?php echo e(route('getLockScreen')); ?>" class='btn btn-default btn-flat'><i class='fa fa-key'></i></a>
                                <a href="javascript:void(0)" onclick="swal({
                                        title: '<?php echo e(trans('crudbooster.alert_want_to_logout')); ?>',
                                        type:'info',
                                        showCancelButton:true,
                                        allowOutsideClick:true,
                                        confirmButtonColor: '#DD6B55',
                                        confirmButtonText: '<?php echo e(trans('crudbooster.button_logout')); ?>',
                                        cancelButtonText: '<?php echo e(trans('crudbooster.button_cancel')); ?>',
                                        closeOnConfirm: false
                                        }, function(){
                                        location.href = '<?php echo e(route("getLogout")); ?>';

                                        });" title="<?php echo e(trans('crudbooster.button_logout')); ?>" class="btn btn-danger btn-flat"><i class='fa fa-power-off'></i></a>
                            </div>
                        </li>
                    </ul>
                </li>
