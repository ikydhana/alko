        ...
        <?php $__currentLoopData = $html_contents['html']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$hc): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            ...
            <?php else: ?>
                <tr>
                    ...
                    <?php $__currentLoopData = $hc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j=>$h): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <td <?php echo e(isset($columns[$j]['style']) ? $columns[$j]['style'] : ''); ?>><?php echo $h; ?></td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
        </tbody>
                                            ...
                                            <div class='col-sm-6'>
                                                <div class='input-group <?php echo e(($col["type_data"] == "time")?"bootstrap-timepicker":""); ?>'>
                                                    ...
                                                    <input
                                                            ...
                                                            <?php echo e((in_array($col["type_data"],["date","datetime","timestamp","time"]))?"readonly":""); ?> placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_from")); ?>'
                                            ...
                                            <div class='col-sm-6'>
                                                <div class='input-group <?php echo e(($col["type_data"] == "time")?"bootstrap-timepicker":""); ?>'>
                                                    ...
                                                    <input
                                                            ...
                                                            type='text'
                                                            class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","datetime","timestamp"]))?"datepicker":(in_array($col["type_data"],["time"]))?"timepicker":""); ?>'
                                                            <?php echo e((in_array($col["type_data"],["date","datetime","timestamp","time"]))?"readonly":""); ?> placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_to")); ?>'
                                                            name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                                                    $value = CRUDBooster::getValueFilter($col["field_with"]);
