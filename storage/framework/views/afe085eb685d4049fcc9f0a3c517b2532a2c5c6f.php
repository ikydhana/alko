...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="<?php echo e(route('postLogin')); ?>" method="post">
            ...
            <div class='row'>
                <div class='col-xs-12' align="center"><p style="padding:10px 0px 10px 0px"><?php echo e(trans("crudbooster.text_forgot_password")); ?> <a
                                href='<?php echo e(route("getForgot")); ?>'><?php echo e(trans("crudbooster.click_here")); ?></a></p></div>
            </div>
        </form>
